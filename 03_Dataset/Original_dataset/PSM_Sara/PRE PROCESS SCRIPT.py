...
import os
path=r'D:\OneDrive - Universidade de Lisboa\5º ano\1º SEMESTRE\PMec\Project\Code\datahandcrafted\datahandcrafted\labels'
os.chdir(path)
...
f=os.listdir(path)
f=f[1:2] # Testing in a smallsubset (excluding the first folder (classes.txt))
